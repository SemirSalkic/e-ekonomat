...
public class ekonomat {
	...
	public static final String URL = "jdbc:mysql://localhost:3306/ekonomat?useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
	public static final String USER = "root";
	public static final String PASS="ekonomat";
	
	
	public ekonomat() {  //Uspjesno poveze (user login info se nalazi u ovoj bazi)
		   try {
